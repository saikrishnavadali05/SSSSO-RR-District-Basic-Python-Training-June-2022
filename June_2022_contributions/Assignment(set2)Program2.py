...
with open(r"C:\Users\UDAY\Desktop\fullname.txt", "r") as f:
    line = f.readline()
data = line.split()
print(data[-1], data[0], data[1])
with open(r"C:\Users\UDAY\Desktop\last_name.txt", "w") as f:
    f.write(data[-1])
with open(r"C:\Users\UDAY\Desktop\first_name.txt", "w") as f:
    f.write(data[0])
with open(r"C:\Users\UDAY\Desktop\middle_name.txt", "w") as f:
    f.write(data[1])