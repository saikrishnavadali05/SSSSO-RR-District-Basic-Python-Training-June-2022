# Write a program to create variables storing values for each datatype. print the object identities of all the created variables. 
# Next, convert the types of the each varible into another type. After changing the type, store all the values of all the variables in a list. Finally, Print the list.
...
if (Enter_Comparizon_number1 == Enter_Comparizon_number2):
    ...
    Flag = True
    print("The Flag is",Flag, "which means",Enter_Comparizon_number2, "is greater than", Enter_Comparizon_number1)